...
import { CUBIQA_URL } from "@/data/site";

/**
 * Crédito de estudio: isotipo de CUBIQA fijo abajo a la derecha, en TODAS las
 * pantallas (montado en el layout raíz). Linkea a la landing de showrooms del
 * estudio (ver `CUBIQA_URL`). z-40 → por encima del contenido base, por debajo de
 * los modales (z-140+), así no tapa sus controles.
 */
