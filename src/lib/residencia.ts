...
// Renders de marketing del hero para las unidades SIN tour 360° (pedido del
// cliente, 2026-06-29): la view 7 como imagen grande + las views 8, 9 y 4 como los
// tres thumbs de abajo. Aplica a TODAS las unidades sin `tour360` (las que tienen
// tour muestran el 360° embebido y no pasan por acá). Una unidad puede igual traer
// su propia `gallery` en units.json para pisar este default.
const DEFAULT_HERO_VIEWS = [
  "/gallery/optimized/view-07.webp",
  "/gallery/optimized/view-08.webp",
  "/gallery/optimized/view-09.webp",
  "/gallery/optimized/view-04.webp",
];

/** Galería del hero: la de la unidad (si la trae), o los renders de marketing por
 *  defecto — view 7 grande + 8/9/4 como thumbs. */
